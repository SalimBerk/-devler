    ...
    if ($_SERVER["REQUEST_METHOD"]=="POST") {
        ...
        if(empty($title_err) && empty($description_err)){
            if( createBlog($title,$description,$image,$url)){
                $_SESSION["message"] = "Yükleme işlemi Başarılı Oldu";
...
<div class="alert alert-danger p-4 m-0 text-center"  role="alert">
  <?php echo "Yükleme Sırasında Bir Hata Oluştu" ?>
</div>
<?else:?>
    <?php if(empty($title_err) && empty($description_err)): ?>
<div id="alertDiv" class="alert alert-success p-4 m-0 text-center"  role="alert">
  <?php echo "Yükleme Başarılı Oldu" ?>
</div>
<?php endif;?>
<?php endif; ?>
